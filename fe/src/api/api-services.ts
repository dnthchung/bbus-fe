...
interface ApiServices {
  ...
  route: {
    ...
    create_a_route: (route: any, checkpointTime: any) => Promise<any>
  }
  requests: {
...
export const API_SERVICES: ApiServices = {
  ...
  route: {
    ...
    create_a_route: (route: any, checkpointTime: any) => apiClient.post(API_ENDPOINTS.ROUTE.CREATE_A_ROUTE, { route, checkpointTime }),
  },
  requests: {
