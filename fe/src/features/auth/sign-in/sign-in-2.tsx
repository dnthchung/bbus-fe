    ...
    <div className='container relative grid h-svh flex-col items-center justify-center lg:max-w-none lg:grid-cols-2 lg:px-0'>
      <div className='relative hidden h-full flex-col bg-muted p-10 text-white dark:border-r lg:flex'>
        ...
        <div className='relative z-20 flex items-center text-lg font-medium'>
          ...
          {/* Quản trị viên Shadcn */}
        </div>
        {/* <img src={ViteLogo} className='relative m-auto' width={301} height={60} alt='Vite' /> */}
        <div className='relative z-20 mt-auto'>
          <blockquote className='space-y-2'>
            {/* <p className='text-lg'>&ldquo;Mẫu thiết kế này đã tiết kiệm cho tôi rất nhiều thời gian và giúp tôi mang đến những thiết kế ấn tượng cho khách hàng nhanh hơn bao giờ hết.&rdquo;</p>
        ...
        <div className='mx-auto flex w-full flex-col justify-center space-y-2 sm:w-[350px]'>
          <div className='flex flex-col space-y-2 text-left'>
            ...
            <p className='text-sm text-muted-foreground'>
              Nhập email và mật khẩu của bạn dưới đây <br /> để đăng nhập vào tài khoản của bạn
            </p>
          </div>
          <UserAuthForm />
